...
# to calculate the new QTR value.
PDuration$QTR <- unlist(lapply(PDuration$month_num_created, function(month) determine_QTR(month)))

#Create Cycle 
#Cycle
>>>>>>> 9b9e3bde3b71e8a7bbe8a3e7b557fe059634e575
